...
Je.post("/analyze", async (e) => {
	let { doc_type: t, filename: n, entity_id: r, entity_type: i = "project", user_id: a = "system" } = await e.req.json(), o = Ye(t, n), s = L("doc"), c = R();
...
}), $.route("/api/v1/products", B), $.route("/api/v1/applications", V), $.route("/api/v1/ai", H), $.route("/api/v1/compliance", W), $.route("/api/v1/projects", G), $.route("/api/v1/documents", Je), $.route("/api/v1/escrow", Xe), $.route("/api/v1/audit", Ze), $.route("/api/v1/users", K), $.route("/api/v1/seed", Qe), $.route("/api/v1/portal", q), $.route("/api/v1/markets", J), $.route("/api/v1/rule-matrices", Y), $.route("/api/v1/compliance-tags", Z), $.route("/api/v1/workflow-templates", Q), $.route("/api/v1", X), $.get("/api/v1/img-proxy", async (e) => {
